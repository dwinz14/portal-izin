<x-guest-layout>
    <div x-data="{
        ...
        <div class="text-center pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <form id="resend-form" method="POST" action="{{ route('password.otp.resend') }}">@csrf</form>
        ...
        <div class="text-center">
            <a href="{{ route('password.request') }}"
                class="text-sm text-slate-500 hover:text-primary-600 dark:text-slate-400 transition-colors">
                ← Masukkan NIK lain
            </a>
        </div>
    </div>
