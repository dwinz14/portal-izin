               ...
               text-indigo-600 shadow-sm focus:ring-indigo-500"
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <label class="flex items-start space-x-3 cursor-pointer">
                        <input type="hidden" name="is_annual_leave" value="0">
                        <input id="is_annual_leave" name="is_annual_leave" type="checkbox" value="1"
                            ...
                            {{ old('is_annual_leave', $leaveType->is_annual_leave) ? 'checked' : '' }}>
