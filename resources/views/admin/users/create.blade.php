            ...
            <div
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Pastikan seluruh data bertanda bintang
                            (<span class="text-red-500">*</span>) diisi dengan benar.</p>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}"
                                    placeholder="contoh: user@perusahaan.com" required
                                    class="block w-full rounded-xl border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-gray-100 text-sm pl-10 pr-4 py-2.5 shadow-sm focus:border-primary-500 focus:ring-primary-500 transition" />
                            </div>
                            @error('email')
                                <p class="mt-1 text-xs font-semibold text-red-600 dark:text-red-400">{{ $message }}
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <x-text-input id="phone" name="phone" type="tel"
                                    class="block w-full pl-10" value="{{ old('phone') }}" inputmode="numeric"
                                    placeholder="08xxxxxxxxxx (opsional)" maxlength="16" />
                            </div>
                            @error('phone')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Untuk notifikasi WhatsApp. Kosongkan jika tidak diperlukan.
                            </p>
                        </div>
                        ...
                        <div
                            class="bg-blue-50/80 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/60 rounded-xl p-3.5 flex items-start gap-3">
                            <div
                            ...
                            <div class="text-xs text-blue-900 dark:text-blue-200">
                                <span class="font-bold">Password Akun Baru:</span> Password akan otomatis disetel ke
                                default (<code
                                    class="bg-white dark:bg-slate-800 px-1.5 py-0.5 rounded text-primary-600 dark:text-primary-400 font-mono font-bold">{{ config('app.default_user_password', 'password123') }}</code>).
                                Karyawan akan diminta mengubah password saat pertama kali login.
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="date" id="tanggal_aktif_kerja" name="tanggal_aktif_kerja"
                                    value="{{ old('tanggal_aktif_kerja') }}" max="{{ now()->format('Y-m-d') }}"
                                    class="block w-full rounded-xl border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-gray-100 text-sm px-3.5 py-2.5 shadow-sm focus:border-primary-500 focus:ring-primary-500 transition" />
                            </div>
